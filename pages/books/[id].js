...
import booksPageInitialPathsE6faaResource from '../../resources/books-page-initial-paths-e6faa'
import booksPageInitialProps75ed5Resource from '../../resources/books-page-initial-props-75ed5'
  ...
  return (
    <>
      <div className="books11-container">
        <Head>
          <title>Books1 - Chief Factors Coordinator</title>
          <meta
            property="og:title"
            content="Books1 - Chief Factors Coordinator"
          />
        </Head>
        <DataProvider
...
export async function getStaticPaths() {
  const response = await booksPageInitialPathsE6faaResource({})
  return {
...
export async function getStaticProps(context) {
  const response = await booksPageInitialProps75ed5Resource({
    ...context?.params,
  })
  return {
    props: {
